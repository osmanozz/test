...
<html lang="en">
    ...
    <body>
        ...
        if(is_array($dataset) && !empty($dataset)){ 
            ...
            <caption style="caption-side:top"><h2>Bestellen product</h2></caption>
            ...
            <tr>
                ...
                <?php foreach($dataset as $rows=>$row){ 
                    ...
                    <td>
                        <a href="bestellen-product.php?product_code=<?php echo trim($row['product_code']); ?>
                        &prijs_per_stuk=<?php echo trim($row['prijs_per_stuk']); ?>
                        &tafel_code=<?php echo trim($_GET['tafel_code']); ?>"
                        class="btn btn-primary" >Bestellen</a>
                    </td>
